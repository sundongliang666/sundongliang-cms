...
<form name="articleform"  id="articleform">
 ...
 <div class="form-group"><input type="hidden" name="picture" value="${article.picture}">
    <label for="exampleFormControlFile1">文章图片</label><img alt="" width="50px;" height="50px;" src="/pic/${article.picture}">
    <input type="file" class="form-control-file" id="file" name="file">
  </div>
  
  <div class="form-group">
    <label for="content1">文章内容</label>
    <textarea name="content"    id="contentId" cols="200" rows="200" style="width:700px;height:200px;visibility:hidden;">${content1}</textarea> 
	...
	$("#channel").change(function(){
	 ...
	 $(document).ready( function(){
		...
		KindEditor.ready(function(K) {
			...
			uploadJson:'/article/uploads.do', // 
			fileManagerJson:'/article/manager',
		...
		console.log("222222222222")
		  ...
		  $.ajax({url:"/article/update",
			  ...
			  success:function(data){
				  ...
				  //  
				  showWork($("#postLink"),"/article/articles")
			  }
			  })

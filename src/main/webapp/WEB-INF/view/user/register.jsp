...
<body>
	<div class="form row">  
			<form:form action="register" modelAttribute="user" method="post" class="form-horizontal col-sm-offset-3 col-md-offset-3  form" id="register_form">
					
				<h3 class="form-title">注册新的用户</h3>				
					<div class="col-sm-9 col-md-9">					
						<div class="form-group">	<!-- placeholder="用户名" -->					
							<i class="fa fa-user fa-lg">用户名</i><br>						
							<form:input   path="username" aria-describedby="emailHelp" remote="/user/checkname"/><input type="button" class="btn btn-info pull-left" onclick="add()" id="back_btn" value="验证"/> 					
